var StarNameGenerator = (function() {
	...
	// Blackholes
	var blackholeUniqueNames = ["Hawking's Eye"];

	var blackholeFirstNames = ["Hole", "Pit", "Void", "Gape", "Tear", "Vision"];

	var blackholeLastNames = ["Of Despair", "Of Pain", "Of The End"];

	// Planets
	var uniqueNames = ["Here Be Dragons", "Sol", "Valhalla"];
	...
	function countUniqueNames() {
		return uniqueNames.length + firstNames.length * lastNames.length;
	}
	...
	return {
		...
		countUniqueNames: countUniqueNames
	}
